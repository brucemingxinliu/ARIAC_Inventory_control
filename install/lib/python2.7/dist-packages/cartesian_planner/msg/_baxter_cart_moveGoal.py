...
"""autogenerated by genpy from cartesian_planner/baxter_cart_moveGoal.msg. Do not edit."""
import sys
...
class baxter_cart_moveGoal(genpy.Message):
  _md5sum = "5e97d1f489faef2083dac5dbabd62387"
  _type = "cartesian_planner/baxter_cart_moveGoal"
...
"""
  ...
  RT_ARM_PLAN_JSPACE_PATH_CURRENT_TO_CART_POSE = 30
  ...
  __slots__ = ['command_code','des_pose_gripper_right','des_pose_gripper_left','des_pose_flange_right','des_pose_flange_left','gripper_opening_right','gripper_opening_left','arm_dp_right','arm_dp_left','q_goal_right','q_goal_left','move_time','time_scale_stretch_factor']
  _slot_types = ['int32','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','float64','float64','float64[]','float64[]','float64[]','float64[]','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       command_code,des_pose_gripper_right,des_pose_gripper_left,des_pose_flange_right,des_pose_flange_left,gripper_opening_right,gripper_opening_left,arm_dp_right,arm_dp_left,q_goal_right,q_goal_left,move_time,time_scale_stretch_factor
    ...
    """
    if args or kwds:
      super(baxter_cart_moveGoal, self).__init__(*args, **kwds)
      ...
      if self.des_pose_flange_right is None:
        self.des_pose_flange_right = geometry_msgs.msg.PoseStamped()
      if self.des_pose_flange_left is None:
        self.des_pose_flange_left = geometry_msgs.msg.PoseStamped()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.des_pose_gripper_left.pose.position.x, _x.des_pose_gripper_left.pose.position.y, _x.des_pose_gripper_left.pose.position.z, _x.des_pose_gripper_left.pose.orientation.x, _x.des_pose_gripper_left.pose.orientation.y, _x.des_pose_gripper_left.pose.orientation.z, _x.des_pose_gripper_left.pose.orientation.w, _x.des_pose_flange_right.header.seq, _x.des_pose_flange_right.header.stamp.secs, _x.des_pose_flange_right.header.stamp.nsecs))
      _x = self.des_pose_flange_right.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.des_pose_flange_right.pose.position.x, _x.des_pose_flange_right.pose.position.y, _x.des_pose_flange_right.pose.position.z, _x.des_pose_flange_right.pose.orientation.x, _x.des_pose_flange_right.pose.orientation.y, _x.des_pose_flange_right.pose.orientation.z, _x.des_pose_flange_right.pose.orientation.w, _x.des_pose_flange_left.header.seq, _x.des_pose_flange_left.header.stamp.secs, _x.des_pose_flange_left.header.stamp.nsecs))
      _x = self.des_pose_flange_left.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_9d.pack(_x.des_pose_flange_left.pose.position.x, _x.des_pose_flange_left.pose.position.y, _x.des_pose_flange_left.pose.position.z, _x.des_pose_flange_left.pose.orientation.x, _x.des_pose_flange_left.pose.orientation.y, _x.des_pose_flange_left.pose.orientation.z, _x.des_pose_flange_left.pose.orientation.w, _x.gripper_opening_right, _x.gripper_opening_left))
      ...
      _x = self
      buff.write(_struct_2d.pack(_x.move_time, _x.time_scale_stretch_factor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.des_pose_flange_right.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.des_pose_flange_right.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.des_pose_flange_right.pose.position.x, _x.des_pose_flange_right.pose.position.y, _x.des_pose_flange_right.pose.position.z, _x.des_pose_flange_right.pose.orientation.x, _x.des_pose_flange_right.pose.orientation.y, _x.des_pose_flange_right.pose.orientation.z, _x.des_pose_flange_right.pose.orientation.w, _x.des_pose_flange_left.header.seq, _x.des_pose_flange_left.header.stamp.secs, _x.des_pose_flange_left.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.des_pose_flange_left.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.des_pose_flange_left.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 72
      (_x.des_pose_flange_left.pose.position.x, _x.des_pose_flange_left.pose.position.y, _x.des_pose_flange_left.pose.position.z, _x.des_pose_flange_left.pose.orientation.x, _x.des_pose_flange_left.pose.orientation.y, _x.des_pose_flange_left.pose.orientation.z, _x.des_pose_flange_left.pose.orientation.w, _x.gripper_opening_right, _x.gripper_opening_left,) = _struct_9d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      (_x.move_time, _x.time_scale_stretch_factor,) = _struct_2d.unpack(str[start:end])
      return self
