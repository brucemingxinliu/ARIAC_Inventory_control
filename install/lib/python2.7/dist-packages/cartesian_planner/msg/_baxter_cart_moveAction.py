...
"""autogenerated by genpy from cartesian_planner/baxter_cart_moveAction.msg. Do not edit."""
import sys
...
class baxter_cart_moveAction(genpy.Message):
  _md5sum = "962a7d787c4d14bd1c960a582744a61e"
  _type = "cartesian_planner/baxter_cart_moveAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

baxter_cart_moveActionGoal action_goal
baxter_cart_moveActionResult action_result
baxter_cart_moveActionFeedback action_feedback

================================================================================
MSG: cartesian_planner/baxter_cart_moveActionGoal
...
================================================================================
MSG: cartesian_planner/baxter_cart_moveActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: cartesian_planner/baxter_cart_moveActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
baxter_cart_moveFeedback feedback

================================================================================
MSG: cartesian_planner/baxter_cart_moveFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#feedback: optional; 
int32 fdbk
...
"""
  ...
  _slot_types = ['cartesian_planner/baxter_cart_moveActionGoal','cartesian_planner/baxter_cart_moveActionResult','cartesian_planner/baxter_cart_moveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(baxter_cart_moveAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cartesian_planner.msg.baxter_cart_moveActionGoal()
      if self.action_result is None:
        self.action_result = cartesian_planner.msg.baxter_cart_moveActionResult()
      if self.action_feedback is None:
        self.action_feedback = cartesian_planner.msg.baxter_cart_moveActionFeedback()
    else:
      self.action_goal = cartesian_planner.msg.baxter_cart_moveActionGoal()
      self.action_result = cartesian_planner.msg.baxter_cart_moveActionResult()
      self.action_feedback = cartesian_planner.msg.baxter_cart_moveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_goal.goal.des_pose_gripper_left.pose.position.x, _x.action_goal.goal.des_pose_gripper_left.pose.position.y, _x.action_goal.goal.des_pose_gripper_left.pose.position.z, _x.action_goal.goal.des_pose_gripper_left.pose.orientation.x, _x.action_goal.goal.des_pose_gripper_left.pose.orientation.y, _x.action_goal.goal.des_pose_gripper_left.pose.orientation.z, _x.action_goal.goal.des_pose_gripper_left.pose.orientation.w, _x.action_goal.goal.des_pose_flange_right.header.seq, _x.action_goal.goal.des_pose_flange_right.header.stamp.secs, _x.action_goal.goal.des_pose_flange_right.header.stamp.nsecs))
      _x = self.action_goal.goal.des_pose_flange_right.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_goal.goal.des_pose_flange_right.pose.position.x, _x.action_goal.goal.des_pose_flange_right.pose.position.y, _x.action_goal.goal.des_pose_flange_right.pose.position.z, _x.action_goal.goal.des_pose_flange_right.pose.orientation.x, _x.action_goal.goal.des_pose_flange_right.pose.orientation.y, _x.action_goal.goal.des_pose_flange_right.pose.orientation.z, _x.action_goal.goal.des_pose_flange_right.pose.orientation.w, _x.action_goal.goal.des_pose_flange_left.header.seq, _x.action_goal.goal.des_pose_flange_left.header.stamp.secs, _x.action_goal.goal.des_pose_flange_left.header.stamp.nsecs))
      _x = self.action_goal.goal.des_pose_flange_left.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_9d.pack(_x.action_goal.goal.des_pose_flange_left.pose.position.x, _x.action_goal.goal.des_pose_flange_left.pose.position.y, _x.action_goal.goal.des_pose_flange_left.pose.position.z, _x.action_goal.goal.des_pose_flange_left.pose.orientation.x, _x.action_goal.goal.des_pose_flange_left.pose.orientation.y, _x.action_goal.goal.des_pose_flange_left.pose.orientation.z, _x.action_goal.goal.des_pose_flange_left.pose.orientation.w, _x.action_goal.goal.gripper_opening_right, _x.action_goal.goal.gripper_opening_left))
      ...
      _x = self
      buff.write(_struct_2d3I.pack(_x.action_goal.goal.move_time, _x.action_goal.goal.time_scale_stretch_factor, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_result.result.current_pose_flange_right.pose.position.x, _x.action_result.result.current_pose_flange_right.pose.position.y, _x.action_result.result.current_pose_flange_right.pose.position.z, _x.action_result.result.current_pose_flange_right.pose.orientation.x, _x.action_result.result.current_pose_flange_right.pose.orientation.y, _x.action_result.result.current_pose_flange_right.pose.orientation.z, _x.action_result.result.current_pose_flange_right.pose.orientation.w, _x.action_result.result.current_pose_flange_left.header.seq, _x.action_result.result.current_pose_flange_left.header.stamp.secs, _x.action_result.result.current_pose_flange_left.header.stamp.nsecs))
      _x = self.action_result.result.current_pose_flange_left.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_result.result.current_pose_flange_left.pose.position.x, _x.action_result.result.current_pose_flange_left.pose.position.y, _x.action_result.result.current_pose_flange_left.pose.position.z, _x.action_result.result.current_pose_flange_left.pose.orientation.x, _x.action_result.result.current_pose_flange_left.pose.orientation.y, _x.action_result.result.current_pose_flange_left.pose.orientation.z, _x.action_result.result.current_pose_flange_left.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.des_pose_flange_right.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.des_pose_flange_right.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.action_goal.goal.des_pose_flange_right.pose.position.x, _x.action_goal.goal.des_pose_flange_right.pose.position.y, _x.action_goal.goal.des_pose_flange_right.pose.position.z, _x.action_goal.goal.des_pose_flange_right.pose.orientation.x, _x.action_goal.goal.des_pose_flange_right.pose.orientation.y, _x.action_goal.goal.des_pose_flange_right.pose.orientation.z, _x.action_goal.goal.des_pose_flange_right.pose.orientation.w, _x.action_goal.goal.des_pose_flange_left.header.seq, _x.action_goal.goal.des_pose_flange_left.header.stamp.secs, _x.action_goal.goal.des_pose_flange_left.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.des_pose_flange_left.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.des_pose_flange_left.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 72
      (_x.action_goal.goal.des_pose_flange_left.pose.position.x, _x.action_goal.goal.des_pose_flange_left.pose.position.y, _x.action_goal.goal.des_pose_flange_left.pose.position.z, _x.action_goal.goal.des_pose_flange_left.pose.orientation.x, _x.action_goal.goal.des_pose_flange_left.pose.orientation.y, _x.action_goal.goal.des_pose_flange_left.pose.orientation.z, _x.action_goal.goal.des_pose_flange_left.pose.orientation.w, _x.action_goal.goal.gripper_opening_right, _x.action_goal.goal.gripper_opening_left,) = _struct_9d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      (_x.action_goal.goal.move_time, _x.action_goal.goal.time_scale_stretch_factor, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.current_pose_flange_right.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.current_pose_flange_right.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.action_result.result.current_pose_flange_right.pose.position.x, _x.action_result.result.current_pose_flange_right.pose.position.y, _x.action_result.result.current_pose_flange_right.pose.position.z, _x.action_result.result.current_pose_flange_right.pose.orientation.x, _x.action_result.result.current_pose_flange_right.pose.orientation.y, _x.action_result.result.current_pose_flange_right.pose.orientation.z, _x.action_result.result.current_pose_flange_right.pose.orientation.w, _x.action_result.result.current_pose_flange_left.header.seq, _x.action_result.result.current_pose_flange_left.header.stamp.secs, _x.action_result.result.current_pose_flange_left.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.current_pose_flange_left.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.current_pose_flange_left.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.action_result.result.current_pose_flange_left.pose.position.x, _x.action_result.result.current_pose_flange_left.pose.position.y, _x.action_result.result.current_pose_flange_left.pose.position.z, _x.action_result.result.current_pose_flange_left.pose.orientation.x, _x.action_result.result.current_pose_flange_left.pose.orientation.y, _x.action_result.result.current_pose_flange_left.pose.orientation.z, _x.action_result.result.current_pose_flange_left.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
