...
class cart_moveAction(genpy.Message):
  _md5sum = "2b41f5404c8f8b8d13cb2bd653af3ffa"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.command_code, _x.action_goal.goal.des_pose_gripper.header.seq, _x.action_goal.goal.des_pose_gripper.header.stamp.secs, _x.action_goal.goal.des_pose_gripper.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.action_goal.goal.des_pose_gripper.pose.position.x, _x.action_goal.goal.des_pose_gripper.pose.position.y, _x.action_goal.goal.des_pose_gripper.pose.position.z, _x.action_goal.goal.des_pose_gripper.pose.orientation.x, _x.action_goal.goal.des_pose_gripper.pose.orientation.y, _x.action_goal.goal.des_pose_gripper.pose.orientation.z, _x.action_goal.goal.des_pose_gripper.pose.orientation.w))
      ...
      _x = self
      buff.write(_struct_d3I.pack(_x.action_goal.goal.time_scale_stretch_factor, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.result.current_pose_gripper.header.seq, _x.action_result.result.current_pose_gripper.header.stamp.secs, _x.action_result.result.current_pose_gripper.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_result.result.current_pose_gripper.pose.position.x, _x.action_result.result.current_pose_gripper.pose.position.y, _x.action_result.result.current_pose_gripper.pose.position.z, _x.action_result.result.current_pose_gripper.pose.orientation.x, _x.action_result.result.current_pose_gripper.pose.orientation.y, _x.action_result.result.current_pose_gripper.pose.orientation.z, _x.action_result.result.current_pose_gripper.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.command_code, _x.action_goal.goal.des_pose_gripper.header.seq, _x.action_goal.goal.des_pose_gripper.header.stamp.secs, _x.action_goal.goal.des_pose_gripper.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_goal.goal.des_pose_gripper.pose.position.x, _x.action_goal.goal.des_pose_gripper.pose.position.y, _x.action_goal.goal.des_pose_gripper.pose.position.z, _x.action_goal.goal.des_pose_gripper.pose.orientation.x, _x.action_goal.goal.des_pose_gripper.pose.orientation.y, _x.action_goal.goal.des_pose_gripper.pose.orientation.z, _x.action_goal.goal.des_pose_gripper.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      (_x.action_goal.goal.time_scale_stretch_factor, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.current_pose_gripper.header.seq, _x.action_result.result.current_pose_gripper.header.stamp.secs, _x.action_result.result.current_pose_gripper.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
