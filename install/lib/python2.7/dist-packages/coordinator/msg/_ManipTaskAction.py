...
class ManipTaskAction(genpy.Message):
  _md5sum = "456db2dee54a410bf73beca477e6a205"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_goal.goal.action_code, _x.action_goal.goal.object_code, _x.action_goal.goal.pickup_frame.header.seq, _x.action_goal.goal.pickup_frame.header.stamp.secs, _x.action_goal.goal.pickup_frame.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_goal.goal.pickup_frame.pose.position.x, _x.action_goal.goal.pickup_frame.pose.position.y, _x.action_goal.goal.pickup_frame.pose.position.z, _x.action_goal.goal.pickup_frame.pose.orientation.x, _x.action_goal.goal.pickup_frame.pose.orientation.y, _x.action_goal.goal.pickup_frame.pose.orientation.z, _x.action_goal.goal.pickup_frame.pose.orientation.w, _x.action_goal.goal.dropoff_frame.header.seq, _x.action_goal.goal.dropoff_frame.header.stamp.secs, _x.action_goal.goal.dropoff_frame.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_result.result.manip_return_code, _x.action_result.result.object_grabber_return_code, _x.action_result.result.des_gripper_pose.header.seq, _x.action_result.result.des_gripper_pose.header.stamp.secs, _x.action_result.result.des_gripper_pose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_result.result.object_pose.pose.position.x, _x.action_result.result.object_pose.pose.position.y, _x.action_result.result.object_pose.pose.position.z, _x.action_result.result.object_pose.pose.orientation.x, _x.action_result.result.object_pose.pose.orientation.y, _x.action_result.result.object_pose.pose.orientation.z, _x.action_result.result.object_pose.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.feedback_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.action_code, _x.action_goal.goal.object_code, _x.action_goal.goal.pickup_frame.header.seq, _x.action_goal.goal.pickup_frame.header.stamp.secs, _x.action_goal.goal.pickup_frame.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_goal.goal.dropoff_frame.pose.position.x, _x.action_goal.goal.dropoff_frame.pose.position.y, _x.action_goal.goal.dropoff_frame.pose.position.z, _x.action_goal.goal.dropoff_frame.pose.orientation.x, _x.action_goal.goal.dropoff_frame.pose.orientation.y, _x.action_goal.goal.dropoff_frame.pose.orientation.z, _x.action_goal.goal.dropoff_frame.pose.orientation.w, _x.action_goal.goal.perception_source, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_7di3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.manip_return_code, _x.action_result.result.object_grabber_return_code, _x.action_result.result.des_gripper_pose.header.seq, _x.action_result.result.des_gripper_pose.header.stamp.secs, _x.action_result.result.des_gripper_pose.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.des_gripper_pose.pose.position.x, _x.action_result.result.des_gripper_pose.pose.position.y, _x.action_result.result.des_gripper_pose.pose.position.z, _x.action_result.result.des_gripper_pose.pose.orientation.x, _x.action_result.result.des_gripper_pose.pose.orientation.y, _x.action_result.result.des_gripper_pose.pose.orientation.z, _x.action_result.result.des_gripper_pose.pose.orientation.w, _x.action_result.result.object_finder_return_code, _x.action_result.result.object_pose.header.seq, _x.action_result.result.object_pose.header.stamp.secs, _x.action_result.result.object_pose.header.stamp.nsecs,) = _struct_7di3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.feedback_status,) = _struct_i.unpack(str[start:end])
      return self
