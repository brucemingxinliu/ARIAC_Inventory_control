...
class ManipTaskGoal(genpy.Message):
  _md5sum = "627ed0128bb1960df6e10bd56742a6f9"
...
"""
  ...
  __slots__ = ['action_code','object_code','pickup_frame','dropoff_frame','perception_source']
  _slot_types = ['int32','int32','geometry_msgs/PoseStamped','geometry_msgs/PoseStamped','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       action_code,object_code,pickup_frame,dropoff_frame,perception_source
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7di.pack(_x.dropoff_frame.pose.position.x, _x.dropoff_frame.pose.position.y, _x.dropoff_frame.pose.position.z, _x.dropoff_frame.pose.orientation.x, _x.dropoff_frame.pose.orientation.y, _x.dropoff_frame.pose.orientation.z, _x.dropoff_frame.pose.orientation.w, _x.perception_source))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.dropoff_frame.pose.position.x, _x.dropoff_frame.pose.position.y, _x.dropoff_frame.pose.position.z, _x.dropoff_frame.pose.orientation.x, _x.dropoff_frame.pose.orientation.y, _x.dropoff_frame.pose.orientation.z, _x.dropoff_frame.pose.orientation.w, _x.perception_source,) = _struct_7di.unpack(str[start:end])
      return self
