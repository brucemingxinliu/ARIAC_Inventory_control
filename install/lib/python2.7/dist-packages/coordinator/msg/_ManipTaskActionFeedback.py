...
class ManipTaskActionFeedback(genpy.Message):
  _md5sum = "7ac844bd84214ba926be9aa034761e36"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.feedback.feedback_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback_status,) = _struct_i.unpack(str[start:end])
      return self
