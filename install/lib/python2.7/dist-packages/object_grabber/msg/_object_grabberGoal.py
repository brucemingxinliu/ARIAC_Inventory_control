...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_7i3I.pack(_x.action_code, _x.object_id, _x.grasp_option, _x.approach_strategy, _x.lift_object_strategy, _x.dropoff_strategy, _x.dropoff_withdraw_strategy, _x.object_frame.header.seq, _x.object_frame.header.stamp.secs, _x.object_frame.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_8d.pack(_x.object_frame.pose.position.x, _x.object_frame.pose.position.y, _x.object_frame.pose.position.z, _x.object_frame.pose.orientation.x, _x.object_frame.pose.orientation.y, _x.object_frame.pose.orientation.z, _x.object_frame.pose.orientation.w, _x.speed_factor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_code, _x.object_id, _x.grasp_option, _x.approach_strategy, _x.lift_object_strategy, _x.dropoff_strategy, _x.dropoff_withdraw_strategy, _x.object_frame.header.seq, _x.object_frame.header.stamp.secs, _x.object_frame.header.stamp.nsecs,) = _struct_7i3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.object_frame.pose.position.x, _x.object_frame.pose.position.y, _x.object_frame.pose.position.z, _x.object_frame.pose.orientation.x, _x.object_frame.pose.orientation.y, _x.object_frame.pose.orientation.z, _x.object_frame.pose.orientation.w, _x.speed_factor,) = _struct_8d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
