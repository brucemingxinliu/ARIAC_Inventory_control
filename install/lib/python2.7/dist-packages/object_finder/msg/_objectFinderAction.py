...
class objectFinderAction(genpy.Message):
  _md5sum = "3ecd323973ae930d9a4ddbd79b6bdc9d"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_iBf3I.pack(_x.action_goal.goal.object_id, _x.action_goal.goal.known_surface_ht, _x.action_goal.goal.surface_ht, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.found_object_code, _x.action_result.result.object_pose.header.seq, _x.action_result.result.object_pose.header.stamp.secs, _x.action_result.result.object_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.object_id, _x.action_goal.goal.known_surface_ht, _x.action_goal.goal.surface_ht, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_iBf3I.unpack(str[start:end])
      ...
      (_x.action_result.result.found_object_code, _x.action_result.result.object_pose.header.seq, _x.action_result.result.object_pose.header.stamp.secs, _x.action_result.result.object_pose.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
