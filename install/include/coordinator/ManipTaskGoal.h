...
struct MD5Sum< ::coordinator::ManipTaskGoal_<ContainerAllocator> >
{
  ...
  {
    return "627ed0128bb1960df6e10bd56742a6f9";
  }

  static const char* value(const ::coordinator::ManipTaskGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x627ed0128bb1960dULL;
  static const uint64_t static_value2 = 0xf6e10bd56742a6f9ULL;
};
