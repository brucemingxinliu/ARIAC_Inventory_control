...
struct MD5Sum< ::coordinator::ManipTaskAction_<ContainerAllocator> >
{
  ...
  {
    return "456db2dee54a410bf73beca477e6a205";
  }

  static const char* value(const ::coordinator::ManipTaskAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x456db2dee54a410bULL;
  static const uint64_t static_value2 = 0xf73beca477e6a205ULL;
};
