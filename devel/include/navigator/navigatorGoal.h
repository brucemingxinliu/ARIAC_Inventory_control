...
struct MD5Sum< ::navigator::navigatorGoal_<ContainerAllocator> >
{
  ...
  {
    return "d0fd46f485a76ea33d779ecc06787188";
  }

  static const char* value(const ::navigator::navigatorGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd0fd46f485a76ea3ULL;
  static const uint64_t static_value2 = 0x3d779ecc06787188ULL;
};
