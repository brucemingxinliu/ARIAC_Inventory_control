...
class navigatorActionGoal(genpy.Message):
  _md5sum = "a1440348af8ccc35f4469a559a75a2fc"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.goal.location_code))
      length = len(self.goal.desired_pose)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.desired_pose:
        _v1 = val1.header
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.goal.nav_path.header.seq, _x.goal.nav_path.header.stamp.secs, _x.goal.nav_path.header.stamp.nsecs))
      _x = self.goal.nav_path.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.goal.nav_path.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.nav_path.poses:
        _v6 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.goal.location_code,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.desired_pose = []
      for i in range(0, length):
        ...
        self.goal.desired_pose.append(val1)
      _x = self
      start = end
      end += 12
      (_x.goal.nav_path.header.seq, _x.goal.nav_path.header.stamp.secs, _x.goal.nav_path.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.goal.nav_path.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.goal.nav_path.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.nav_path.poses = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.PoseStamped()
        _v16 = val1.header
        start = end
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
        self.goal.nav_path.poses.append(val1)
      return self
