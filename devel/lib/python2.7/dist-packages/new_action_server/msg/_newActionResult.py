...
"""autogenerated by genpy from new_action_server/newActionResult.msg. Do not edit."""
import sys
...
class newActionResult(genpy.Message):
  _md5sum = "a9cda3e73a8c2622f0b1386808cf5315"
  _type = "new_action_server/newActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','new_action_server/newResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(newActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = new_action_server.msg.newResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = new_action_server.msg.newResult()
