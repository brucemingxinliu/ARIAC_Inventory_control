...
"""autogenerated by genpy from new_action_server/newAction.msg. Do not edit."""
import sys
...
import genpy
import new_action_server.msg
import std_msgs.msg

class newAction(genpy.Message):
  _md5sum = "860fabd9b9da4b0895202f0965e00551"
  _type = "new_action_server/newAction"
...
"""
  ...
  _slot_types = ['new_action_server/newActionGoal','new_action_server/newActionResult','new_action_server/newActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(newAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = new_action_server.msg.newActionGoal()
      if self.action_result is None:
        self.action_result = new_action_server.msg.newActionResult()
      if self.action_feedback is None:
        self.action_feedback = new_action_server.msg.newActionFeedback()
    else:
      self.action_goal = new_action_server.msg.newActionGoal()
      self.action_result = new_action_server.msg.newActionResult()
      self.action_feedback = new_action_server.msg.newActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4i3I.pack(_x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.z, _x.action_goal.goal.a, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.z, _x.action_goal.goal.a, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_4i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
