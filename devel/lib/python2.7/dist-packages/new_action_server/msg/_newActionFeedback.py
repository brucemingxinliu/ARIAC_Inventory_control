...
"""autogenerated by genpy from new_action_server/newActionFeedback.msg. Do not edit."""
import sys
...
class newActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "new_action_server/newActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','new_action_server/newFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(newActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = new_action_server.msg.newFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = new_action_server.msg.newFeedback()
