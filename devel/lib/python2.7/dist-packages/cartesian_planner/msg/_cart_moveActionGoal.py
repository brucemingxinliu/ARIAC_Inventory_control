...
class cart_moveActionGoal(genpy.Message):
  _md5sum = "4e15fabc8dfb578cb5b7f91af3d942c9"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.goal.command_code, _x.goal.des_pose_gripper.header.seq, _x.goal.des_pose_gripper.header.stamp.secs, _x.goal.des_pose_gripper.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.goal.des_pose_gripper.pose.position.x, _x.goal.des_pose_gripper.pose.position.y, _x.goal.des_pose_gripper.pose.position.z, _x.goal.des_pose_gripper.pose.orientation.x, _x.goal.des_pose_gripper.pose.orientation.y, _x.goal.des_pose_gripper.pose.orientation.z, _x.goal.des_pose_gripper.pose.orientation.w))
      ...
      buff.write(_struct_d.pack(self.goal.time_scale_stretch_factor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.command_code, _x.goal.des_pose_gripper.header.seq, _x.goal.des_pose_gripper.header.stamp.secs, _x.goal.des_pose_gripper.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.goal.des_pose_gripper.pose.position.x, _x.goal.des_pose_gripper.pose.position.y, _x.goal.des_pose_gripper.pose.position.z, _x.goal.des_pose_gripper.pose.orientation.x, _x.goal.des_pose_gripper.pose.orientation.y, _x.goal.des_pose_gripper.pose.orientation.z, _x.goal.des_pose_gripper.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      (self.goal.time_scale_stretch_factor,) = _struct_d.unpack(str[start:end])
      return self
